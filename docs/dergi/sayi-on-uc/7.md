...
::: content
# [çeviri şiir: louis macneice - ersin engin]{.field .field--name-title .field--type-string .field--label-hidden} {#çeviri-şiir-louis-macneice---ersin-engin .title .page-title}
:::
:::
...
14/02/2007 - 22:29]{.field .field--name-created .field--type-created
...
[HOUSE]{.caps} [ON]{.caps} A [CLIFF]{.caps}
...
::: field__item
[louis macneice](/index.php/kisiler/louis.macneice){hreflang="tr"}
:::

::: field__item
[ersin engin](/index.php/kisiler/ersin.engin){hreflang="tr"}
:::
:::
...
-   Yorum yazmak için [giriş
    yapın](/index.php/user/login?destination=/index.php/dergi/13/ceviri.siir.louis.macneice-ersin.engin%23comment-form)
    ya da [kayıt
    olun](/index.php/user/register?destination=/index.php/dergi/13/ceviri.siir.louis.macneice-ersin.engin%23comment-form)
:::

::: {.section .field .field--name-comment .field--type-comment .field--label-above .comment-wrapper}
:::

## Book traversal links for çeviri şiir: louis macneice - ersin engin {#book-label-3 .visually-hidden}

-   [**‹** temizlikçi kadınlar için ilmühaber - cengiz
    kılçer](/index.php/dergi/13/temizlikci.kadinlar.icin.ilmuhaber-cengiz.kilcer "Önceki sayfaya dön"){rel="prev"}
-   [Yukarı](/index.php/dergi/13 "Üst sayfaya git")
-   [maktûl - safa fersal
    **›**](/index.php/dergi/13/maktul-safa.fersal "Sonraki sayfaya git"){rel="next"}
:::
:::
:::
:::
