...
::: content
# [yalnızım söylemeye dilim varmıyor gözlerimden akan yaş konuştum sayılsın! - halim şafak]{.field .field--name-title .field--type-string .field--label-hidden} {#yalnızım-söylemeye-dilim-varmıyor-gözlerimden-akan-yaş-konuştum-sayılsın---halim-şafak .title .page-title}
:::
:::
...
14/02/2007 - 23:45]{.field .field--name-created .field--type-created
...
::: field__item
[halim şafak](/index.php/kisiler/halim.safak){hreflang="tr"}
:::
:::
...
-   Yorum yazmak için [giriş
    yapın](/index.php/user/login?destination=/index.php/dergi/13/yalnizim.soylemeye.dilim.varmiyor.gozlerimden.akan.yas.konustum.sayilsin-halim.safak%23comment-form)
    ya da [kayıt
    olun](/index.php/user/register?destination=/index.php/dergi/13/yalnizim.soylemeye.dilim.varmiyor.gozlerimden.akan.yas.konustum.sayilsin-halim.safak%23comment-form)
:::

::: {.section .field .field--name-comment .field--type-comment .field--label-above .comment-wrapper}
:::

## Book traversal links for yalnızım söylemeye dilim varmıyor gözlerimden akan yaş konuştum sayılsın! - halim şafak {#book-label-3 .visually-hidden}

-   [**‹** elifli sadi - arzu
    çur](/index.php/dergi/13/elifli.sadi-arzu.cur "Önceki sayfaya dön"){rel="prev"}
-   [Yukarı](/index.php/dergi/13 "Üst sayfaya git")
-   [evden uzakta ya da kayıp - hakkı engin gidener
    **›**](/index.php/dergi/13/evden.uzakta.ya.da.kayip-hakki.engin.gidener "Sonraki sayfaya git"){rel="next"}
:::
:::
:::
:::
