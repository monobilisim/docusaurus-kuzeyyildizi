...
::: content
# [çıkrık sızısı - aziz kemâl hızıroğlu]{.field .field--name-title .field--type-string .field--label-hidden} {#çıkrık-sızısı---aziz-kemâl-hızıroğlu .title .page-title}
:::
:::
...
14/02/2007 - 21:40]{.field .field--name-created .field--type-created
...
::: field__item
[aziz kemal
hızıroğlu](/index.php/kisiler/aziz.kemal.hiziroglu){hreflang="tr"}
:::
:::
...
-   Yorum yazmak için [giriş
    yapın](/index.php/user/login?destination=/index.php/dergi/13/cikrik.sizisi-aziz.kemal.hiziroglu%23comment-form)
    ya da [kayıt
    olun](/index.php/user/register?destination=/index.php/dergi/13/cikrik.sizisi-aziz.kemal.hiziroglu%23comment-form)
:::

::: {.section .field .field--name-comment .field--type-comment .field--label-above .comment-wrapper}
:::

## Book traversal links for çıkrık sızısı - aziz kemâl hızıroğlu {#book-label-3 .visually-hidden}

-   [**‹** pusula - özgür macit & vedat
    kamer](/index.php/dergi/13/pusula-ozgur.macit.vedat.kamer "Önceki sayfaya dön"){rel="prev"}
-   [Yukarı](/index.php/dergi/13 "Üst sayfaya git")
-   [hediye - derya önder
    **›**](/index.php/dergi/13/hediye-derya.onder "Sonraki sayfaya git"){rel="next"}
:::
:::
:::
:::
