...
::: content
# [adın kuma yazılır - metin fındıkçı]{.field .field--name-title .field--type-string .field--label-hidden} {#adın-kuma-yazılır---metin-fındıkçı .title .page-title}
:::
:::
...
14/02/2007 - 22:53]{.field .field--name-created .field--type-created
...
[![](/sites/default/files/styles/medium/public/images/ky13_12.jpg)](/node/979)
:::
...
::: field__item
[metin fındıkçı](/index.php/kisiler/metin.findikci){hreflang="tr"}
:::
:::
...
-   Yorum yazmak için [giriş
    yapın](/index.php/user/login?destination=/index.php/dergi/13/adin.kuma.yazilir-metin.findikci%23comment-form)
    ya da [kayıt
    olun](/index.php/user/register?destination=/index.php/dergi/13/adin.kuma.yazilir-metin.findikci%23comment-form)
:::

::: {.section .field .field--name-comment .field--type-comment .field--label-above .comment-wrapper}
:::

## Book traversal links for adın kuma yazılır - metin fındıkçı {#book-label-3 .visually-hidden}

-   [**‹** orta kat - ulaş
    oral](/index.php/dergi/13/orta.kat-ulas.oral "Önceki sayfaya dön"){rel="prev"}
-   [Yukarı](/index.php/dergi/13 "Üst sayfaya git")
-   [ipler - kerem ışık
    **›**](/index.php/dergi/13/ipler-kerem.isik "Sonraki sayfaya git"){rel="next"}
:::
:::
:::
:::
